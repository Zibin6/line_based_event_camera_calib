...
subplot(1,3,2)
yyaxis left;
plot(nls,0.5*(method_list(5).('median_fx')+method_list(7).('median_fy')),'marker',method_list(5).marker,...
...
plot(nls,0.5*(method_list(6).('median_fx')+method_list(8).('median_fy')),'marker',method_list(6).marker,...
...
yyaxis right;
plot(nls,0.5*(method_list(9).('median_cx')+method_list(11).('median_cx')),'marker',method_list(7).marker,...
...
plot(nls,0.5*(method_list(10).('median_cy')+method_list(12).('median_cy')),'marker',method_list(8).marker,...
