% Algorithm test: Median error w.r.t varying measurement error of angular and linear velocities
%
%
...
plot(w,method_list(2).('median_r'),'marker',method_list(2).marker,...
...
yyaxis right;
plot(w,method_list(3).('median_t'),'marker',method_list(3).marker,...
...
plot(w,method_list(4).('median_t'),'marker',method_list(4).marker,...
...
plot(w,method_list(14).('median_k1'),'marker',method_list(14).marker,...
...
yyaxis right;
plot(w,method_list(15).('median_k2'),'marker',method_list(15).marker,...
...
plot(w,method_list(16).('median_k2'),'marker',method_list(16).marker,...
