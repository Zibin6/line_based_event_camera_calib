...
[K_e0 R_e0 t_e0] =DLT_planar_davis(P_p, p(:,:,1));
[coe0] = GetCoeByLines_Brown(p(:,:,1), P_p, K_e0,R_e0,t_e0, 1,0,0,0, 0);
...
[ K_final, R_final,t_final, coe_final] = Optim_Lines_All_planar_eventcamera( P_p, p, n_PtperLine, K_e, coe, R_e ,t_e ,1, 1, 0, 0, 0, undist_max_iter, undist_eps);
