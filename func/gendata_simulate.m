...
function [P_p,P_n,p,pt,K,R,t] = gendata_simulate(npts)
...
pts2d_u = [u_d
           v_d
           ones(1,npts)];
[pts2d_d] = GetDistortedPtFromIdealImgPt_Brown(pts2d_u,K, [0.01,0.01]);

noisy_pts2d_d = pts2d_d(1:2,:) + 0.1*rand(2,npts);
